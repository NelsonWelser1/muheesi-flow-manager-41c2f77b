      ...
      <div className="p-4">
        ...
        <div className="mb-4">
          <button 
            ...
            className="flex items-center justify-between w-full p-2 text-left font-medium hover:bg-gray-100 rounded-md transition-colors my-[40px]"
          >
            ...
            <div className="ml-7 mt-2 space-y-1 border-l-2 border-gray-200 pl-2">
              <button 
                className={`block w-full text-left p-2 text-sm rounded-md ${
                  activeSection === 'herdManagement' && activeTab === 'inventory' 
              ...
              <button 
                className={`block w-full text-left p-2 text-sm rounded-md ${
                  activeSection === 'herdManagement' && activeTab === 'growth' 
        ...
        <div className="mb-4">
          ...
          {!isCollapsed && expandedSections.milkProduction && (
            <div className="ml-7 mt-2 space-y-1 border-l-2 border-gray-200 pl-2">
              <button 
                className={`block w-full text-left p-2 text-sm rounded-md ${
                  activeSection === 'milkProduction' && activeTab === 'quality' 
                    ? 'bg-blue-50 text-blue-600 font-medium' 
                    : 'hover:bg-gray-100'
                }`} 
        ...
        <div className="mb-4">
          <button 
            ...
            className="flex items-center justify-between w-full p-2 text-left font-medium hover:bg-gray-100 rounded-md transition-colors my-[46px]"
          >
            <div className="flex items-center">
          ...
          {!isCollapsed && expandedSections.analytics && (
            <div className="ml-7 mt-2 space-y-1 border-l-2 border-gray-200 pl-2">
              <button 
                className={`block w-full text-left p-2 text-sm rounded-md ${
                  activeSection === 'analytics' && activeTab === 'production' 
              ...
              <button 
                className={`block w-full text-left p-2 text-sm rounded-md ${
                  activeSection === 'analytics' && activeTab === 'financial' 
                    ? 'bg-green-50 text-green-600 font-medium' 
                    : 'hover:bg-gray-100'
                }`} 
              ...
              <button 
                className={`block w-full text-left p-2 text-sm rounded-md ${
                  activeSection === 'analytics' && activeTab === 'trends' 
                    ? 'bg-green-50 text-green-600 font-medium' 
                    : 'hover:bg-gray-100'
                }`} 
