...
const DairySidebar = ({ activeSection, setActiveSection, activeTab, setActiveTab }) => {
      ...
      <div className="p-4">
        ...
        <div className="mb-4">
          <button 
            ...
            onClick={() => toggleSection('herdManagement')}
          >
          ...
          {expandedSections.herdManagement && (
        ...
        <div className="mb-4">
          <button 
            className="flex items-center justify-between w-full p-2 text-left font-medium hover:bg-gray-100 rounded-md transition-colors"
            onClick={() => toggleSection('milkProduction')}
          >
            <div className="flex items-center">
          ...
          {expandedSections.milkProduction && (
            <div className="ml-7 mt-2 space-y-1 border-l-2 border-gray-200 pl-2">
              <button 
                className={`block w-full text-left p-2 text-sm rounded-md ${activeSection === 'milkProduction' && activeTab === 'daily' ? 'bg-blue-50 text-blue-600 font-medium' : 'hover:bg-gray-100'}`}
                onClick={() => handleSectionClick('milkProduction', 'daily')}
              >
                Daily Records
              </button>
              <button 
                className={`block w-full text-left p-2 text-sm rounded-md ${activeSection === 'milkProduction' && activeTab === 'processing' ? 'bg-blue-50 text-blue-600 font-medium' : 'hover:bg-gray-100'}`}
                onClick={() => handleSectionClick('milkProduction', 'processing')}
              >
                Milk Processing
              </button>
              <button 
