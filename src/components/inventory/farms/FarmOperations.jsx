...
const FarmOperations = ({
  ...
  const {
    ...
    setFarmName,
    saveSchedule
  } = usePlantingHarvestingSchedule(selectedFarm?.id);
  const {
    fetchAllFarms
  } = useFarmInformation();
        ...
        <CardContent className="pt-6">
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <Button size="sm" variant="outline" className="flex items-center gap-2" onClick={() => setShowScheduleRecords(true)}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {!selectedFarm && <div className="space-y-2">
                  <Label htmlFor="farm_name">Farm Name</Label>
                  <Select value={scheduleData.farm_name} onValueChange={value => {
                setFarmName(value);
                ...
                if (farm) {
                  scheduleData.farm_id = farm.id;
                    ...
                    <SelectContent>
                      {loadingFarms ? <div className="flex justify-center items-center p-2">
                          <Loader2 className="h-4 w-4 animate-spin" />
                        </div> : farms.map(farm => <SelectItem key={farm.id} value={farm.farm_name}>
                            {farm.farm_name}
                          </SelectItem>)}
                    </SelectContent>
                  </Select>
              ...
              <div className="space-y-2">
                ...
                <Select value={scheduleData.activity_type} onValueChange={value => handleSelectChange('activity_type', value)}>
                  <SelectTrigger className="w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0">
                      <Calendar mode="single" selected={scheduleData.scheduled_date} onSelect={date => handleDateChange('scheduled_date', date)} />
                    </PopoverContent>
                  </Popover>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0">
                      <Calendar mode="single" selected={scheduleData.expected_completion_date} onSelect={date => handleDateChange('expected_completion_date', date)} />
                    </PopoverContent>
                  </Popover>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea id="notes" name="notes" placeholder="Enter any additional notes" value={scheduleData.notes || ''} onChange={handleInputChange} rows={3} />
              </div>
