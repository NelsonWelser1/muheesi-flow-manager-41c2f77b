...
const MilkReceptionTable = () => {
  ...
  const handleDateRangeSearch = ({ startDate, endDate, granularity }) => {
    console.log('Searching with:', { startDate, endDate, granularity });
  ...
  return <>
      ...
      <Card>
        ...
        <CardContent className="pt-4">
          <DateRangeSearch onSearch={handleDateRangeSearch} onRefresh={handleRefresh} />
