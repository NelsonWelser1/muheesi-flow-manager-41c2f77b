  ...
  return <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="order_date_time" type="datetime-local" {...register("order_date_time", {
          required: "Order date & time is required"
        })} />
        ...
        <div className="space-y-2">
          ...
          <Controller name="delivery_priority" control={control} rules={{
          required: "Delivery priority is required"
        }} render={({
          field
                ...
                <SelectContent>
                  {PRIORITIES.map(priority => <SelectItem key={priority} value={priority}>
                      {priority}
                    </SelectItem>)}
                </SelectContent>
              </Select>} />
        ...
        <div className="space-y-2">
          ...
          <Controller name="order_status" control={control} rules={{
      ...
      <div className="space-y-2">
        ...
        <Textarea id="order_details" {...register("order_details", {
