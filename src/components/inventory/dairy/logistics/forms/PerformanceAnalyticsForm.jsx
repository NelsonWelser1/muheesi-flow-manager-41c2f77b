...
const PerformanceAnalyticsForm = () => {
  ...
  const { addPerformanceRecord, isLoading } = usePerformanceAnalytics();
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          {errors.performance_rating && (
            <p className="text-sm text-red-500">{errors.performance_rating.message}</p>
          )}
        </div>
        ...
        {actionRequired && (
          <div className="ml-6 mt-2">
            ...
            {errors.action_details && (
              <p className="text-sm text-red-500">{errors.action_details.message}</p>
            )}
          </div>
        )}
      </div>
