...
const mockDeliveryData = [
  { day: 'Mon', deliveries: 24 },
  { day: 'Tue', deliveries: 18 },
  { day: 'Wed', deliveries: 30 },
  { day: 'Thu', deliveries: 22 },
  { day: 'Fri', deliveries: 28 },
];

const LogisticsDashboard = () => {
  console.log('Rendering LogisticsDashboard');
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Packages in Transit</CardTitle>
