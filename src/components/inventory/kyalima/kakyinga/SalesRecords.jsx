      ...
      <CardHeader>
        <div className="flex flex-col gap-4">
          ...
          <KakyingaExportActions
            data={sales}
            recordType="Sales Records"
            defaultFileName="kakyinga-sales"
            showDateFilter={true}
            processDataFn={processSalesData}
            exportPdfFn={exportSalesToPDF}
            exportExcelFn={exportSalesToExcel}
            exportCsvFn={exportSalesToCSV}
          />
        </div>
      </CardHeader>
      <CardContent>
