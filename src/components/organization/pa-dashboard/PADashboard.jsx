  ...
  return <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        ...
        <div className="mt-2 sm:mt-0 flex space-x-2">
          <EntitySelector selectedEntity={selectedEntity} onEntityChange={setSelectedEntity} />
          <NotificationsAlerts />
        </div>
      </div>

      <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
        <div className="sticky top-0 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 pb-4 px-0 py-0">
        ...
        <SidebarProvider>
          <div className="flex min-h-[500px]">
            {activeTab !== 'dashboard' && <DashboardSidebar activeTab={activeTab} onViewChange={setCurrentView} isCollapsed={isCollapsed} />}
