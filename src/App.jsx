...
import StorageTankManagement from "./components/inventory/dairy/storage/StorageTankManagement";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/manage-inventory/storage-tanks" element={<StorageTankManagement />} />
          </Routes>
        </BrowserRouter>
      </TooltipProvider>
    </AutoFillProvider>
