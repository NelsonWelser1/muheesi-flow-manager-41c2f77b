...
-- Migration file to update the coffee_inventory table

-- First, drop the existing coffee_inventory table if it exists
DROP TABLE IF EXISTS coffee_inventory;

-- Enable UUID extension if not already enabled
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Create coffee_inventory table with all required columns
