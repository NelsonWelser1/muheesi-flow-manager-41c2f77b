...
CREATE POLICY IF NOT EXISTS "Allow all access for dairy managers and operators"
...
DROP TRIGGER IF EXISTS update_raw_materials_inventory_updated_at ON raw_materials_inventory;
